...
export function ToastPage() {
  return (
    <motion.div 
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      className="h-[calc(100vh-64px)] overflow-hidden flex items-center justify-center"
    >
        ...
        <div className="flex gap-8 items-start">
          <div className="space-y-6 flex-1">
            <motion.div
              ...
              className="space-y-4"
            >
              <h2 className="text-lg font-medium">Here are the key documents for your policy:</h2>
            ...
            >
              ...
              <p className="text-sm text-muted-foreground">
                No worries! Everything has also been sent to your email. 
                Feel free to close the page whenever you're ready. 😊
              </p>
            </motion.div>
          </div>
